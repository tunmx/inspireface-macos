...
#define HF_ENABLE_DETECT_MODE_FACE_LANDMARK \
    0x00000200  ///< Flag to enable face landmark detection feature.
...
typedef struct HFImageBitmapData {
    ...
    HInt32 width;
    HInt32 height;
    HInt32 channels;  // only support 3 channels or 1 channel
 ...
 * @return HResult indicating the success or failure of the operation.
 */
HYPER_CAPI_EXPORT extern HResult HFCreateImageBitmap(PHFImageBitmapData data,
 ...
 * @return HResult indicating the success or failure of the operation.
 */
HYPER_CAPI_EXPORT extern HResult HFCreateImageBitmapFromFilePath(HPath filePath, HInt32 channels,
                                                                 HFImageBitmap *handle);
 ...
 * @return HResult indicating the success or failure of the operation.
 */
HYPER_CAPI_EXPORT extern HResult HFCreateImageStreamFromImageBitmap(HFImageBitmap handle,
                                                                    HFRotation rotation,
 ...
 * @return HResult indicating the success or failure of the operation.
 */
HYPER_CAPI_EXPORT extern HResult HFImageBitmapDrawRect(HFImageBitmap handle, HFaceRect rect,
                                                       HFColor color, HInt32 thickness);
 ...
 * @return HResult indicating the success or failure of the operation.
 */
HYPER_CAPI_EXPORT extern HResult HFImageBitmapDrawCircle(HFImageBitmap handle, HPoint2i point,
                                                         HInt32 radius, HFColor color,
                                                         HInt32 thickness);
 ...
 * @return HResult indicating the success or failure of the operation.
 */
HYPER_CAPI_EXPORT extern HResult HFImageBitmapGetData(HFImageBitmap handle,
                                                      PHFImageBitmapData data);
 ...
 * @return HResult indicating the success or failure of the operation.
 */
HYPER_CAPI_EXPORT extern HResult HFImageBitmapShow(HFImageBitmap handle, HString title,
                                                   HInt32 delay);
...
HYPER_CAPI_EXPORT extern HResult HFInspireFaceConfiguringIOSExtensionCoreMLPackagePath(
  HPath coremlPackage);

/**
 * @brief CoreML inference mode.
 */
typedef enum HFCoreMLInferenceMode {
    HF_COREML_UNITS_CPU_ONLY = 0,     ///< CPU only
    HF_COREML_UNITS_CPU_AND_GPU = 1,  ///< CPU and GPU
    HF_COREML_UNITS_ALL = 2,          ///< Use all available cells, CPU、GPU、Neural Engine
} HFCoreMLInferenceMode;

/**
 * @brief Set Global CoreML inference mode.
 *
 * @param mode The mode of the CoreML inference. Default is HF_COREML_UNITS_ALL.
 * @return HResult indicating the success or failure of the operation.
 */
HYPER_CAPI_EXPORT extern HResult HFSetGlobalCoreMLInferenceMode(HFCoreMLInferenceMode mode);
...
typedef struct HFSessionCustomParameter {
    ...
    HInt32 enable_detect_mode_face_landmark;  ///< Enable face landmark detection feature.
 ...
 *          the need to input a multiple of 160, such as 160, 192, 256, 320, 640, the default value
 * -1 is 160.
 ...
 * @return HResult indicating the success or failure of the operation.
 */
HYPER_CAPI_EXPORT extern HResult HFSessionSetTrackModeNumSmoothCacheFrame(HFSession session,
                                                                          HInt32 num);
 ...
 * @return HResult indicating the success or failure of the operation.
 */
HYPER_CAPI_EXPORT extern HResult HFSessionSetTrackModelDetectInterval(HFSession session,
                                                                      HInt32 num);
...
typedef struct HFFaceFeature {
    ...
    HFloat norm;   ///< Norm of the feature data().
                  // Note: norm is only valid if the 'HFFaceFeatureExtract' interface is used as the
                  // return value
 ...
 * @return HResult indicating the success or failure of the operation.
 */
HYPER_CAPI_EXPORT extern HResult HFFeatureHubGetFaceIdentity(HInt32 id,
...
/**
 * @brief SDK license validity time
 */
typedef struct HFExpiryDate {
    HInt32 year;
    HInt32 month;
    HInt32 day;
    HInt32 expiry;  ///< 1: expiry; 0: usable
} HFExpiryDate, *PHFExpiryDate;

/**
 * @brief Query the expiration time of the SDK
 */
HYPER_CAPI_EXPORT extern HResult HFQueryInspireFacEexpiration(PHFExpiryDate time);
