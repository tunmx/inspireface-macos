...
#define HERR_EXTENSION_ERROR                (HERR_SESS_BASE+100)               // Extension module error
#define HERR_EXTENSION_MLMODEL_LOAD_FAILED     (HERR_SESS_BASE+101)              // MLModel load failed
#define HERR_EXTENSION_HETERO_MODEL_TAG_ERROR     (HERR_SESS_BASE+102)            //Incorrect heterogeneous model tag
#define HERR_EXTENSION_HETERO_REC_HEAD_CONFIG_ERROR     (HERR_SESS_BASE+103)      // Rec head config error
#define HERR_EXTENSION_HETERO_MODEL_NOT_MATCH     (HERR_SESS_BASE+104)      // Heterogeneous model dimensions do not match
#define HERR_EXTENSION_HETERO_MODEL_NOT_LOADED     (HERR_SESS_BASE+105)      // Heterogeneous model dimensions not loaded
